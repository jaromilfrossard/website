...
The formula of lme4 allows user to specify several type of random design. However it handels the factor in an unintuive way. Moreover in order to have a estimable model we need to delete the higher order random effect confounded with the error of the model. 
