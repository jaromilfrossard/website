...
From the EEG signal, we need to construct a 3D array storing all measures of the signal. The first dimension store the design (29 subjects $\times$ 2 Actiona $\times$ 2 stimulus  = 116), the second dimension represents each time-points (around 400 for 800 ms at 512Hz) and the third dimension represents all 64 electrodes.
